...
// PSRAM -> OPI PSRAM
// Partition Scheme -> 16M Flash(HUGE APP 3MB APP/9.9MB FATFS)
...
void setup()
{
    ...
    Serial.begin(115200); //Ensure serial monitor is also at 115200 baud rate
    ...
    ***********************************/
    if (use_ap_mode) {
        ...
        wifiMulti.addAP("", ""); //add ssid and password in each string respectively, (try to use the network of the arduino and place empty string as psswd, it might work this time)
